        ...
        {step === "clarification" && preview && (
          <>
            <DialogHeader>
              ...
              <DialogDescription>
                AI needs a bit more context to accurately categorise your skill.
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-5 pt-1">
              ...
              <div className="rounded-lg border border-border bg-muted/20 p-4 space-y-4">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <ChipList items={preview.ai.technologies} variant="outline" />
                </div>
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <ChipList items={preview.ai.relatedSkills} variant="muted" />
                </div>
              ...
              <div className="rounded-lg border border-border bg-muted/10 p-4 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  <div>
                    ...
                    <p className="font-medium">{form.currentLevel || "—"}</p>
                  </div>
                  <div>
                    <p className="text-[10px] font-semibold uppercase tracking-wider text-muted-foreground mb-0.5">
                      Session Mode
                  ...
                  <div>
                    ...
                    <p className="font-medium">{form.availability || "—"}</p>
                  </div>
                  <div>
                    <p className="text-[10px] font-semibold uppercase tracking-wider text-muted-foreground mb-0.5">
                      Language
              ...
              {preview.ai.confidence < 50 && (
                <div className="flex items-start gap-2 rounded-lg border border-amber-200 bg-amber-50 p-3 text-xs text-amber-800 dark:border-amber-800 dark:bg-amber-950/30 dark:text-amber-300">
                  ...
                  <span>
                    Low confidence — please review the extracted data carefully
                    before saving.
                  </span>
                </div>
              )}
